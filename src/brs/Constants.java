...
public final class Constants {
    ...
    //修改此账号为总账号
    public static final long MAIN_ACCOUNT = 2224779260385810396l;

    //所有代理账号以,连接
    public static final String AGENT_ACCOUNTS = "5464828497518094976";
    //奖励给基金会比例5%
    ...
    //每天固定奖励数为308880*100000000
    public static final BigDecimal ONE_DAY_REWARDS = new BigDecimal(30888000000000L);
    //块奖励 858
    public static final int BLOCK_REWARD = 858;
    //申请冻结时间 15天
